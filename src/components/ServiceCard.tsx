...
export default function ServiceCard({
  ...
  return (
    <div className="card-futuristic group flex flex-col rounded-xl p-8 transition-all duration-300">
      <div className="mb-5 inline-flex self-start rounded-lg border border-cyan/20 bg-cyan/5 p-3 text-cyan transition-colors duration-300 group-hover:bg-cyan/10">
