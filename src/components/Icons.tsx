...
export function UsersIcon({ className = "h-8 w-8" }: IconProps) {
  return (
...
export function DumbbellIcon({ className = "h-8 w-8" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 7h2v10H3V7zm16 0h2v10h-2V7zm-2 2h-2V7H9v2H7v6h2v2h8v-2h2V9zM5 9h2v6H5V9zm12 0h2v6h-2V9z" />
    </svg>
  );
}
...
export function TargetIcon({ className = "h-8 w-8" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 12m-9 0a9 9 0 1 0 18 0 9 9 0 1 0-18 0m9-5a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 3a2 2 0 1 0 0 4 2 2 0 0 0 0-4z" />
    </svg>
  );
}

export function HeartIcon({ className = "h-8 w-8" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function LockIcon({ className = "h-8 w-8" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function UserGroupIcon({ className = "h-8 w-8" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
